 ...
 *
 */
public class DiaoBoDAO extends BaseDAO {
	public DiaoBoItem getAcntItemFromDiaoBo(Sheet sheet, int startRowIndex) {
		DiaoBoItem item = new DiaoBoItem();
		...
		try {
			...
			for (int i = 0; i < StaticVariables.SubItemsCnt_CaiLiaoDiaoBoDan; i++) {
				int rowIndex = startRowIndex
						+ StaticVariables.SubItemStartRow_CaiLiaoDiaoBoDan + i;
