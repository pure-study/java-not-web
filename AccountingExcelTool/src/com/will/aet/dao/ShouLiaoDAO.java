 ...
 *
 */
public class ShouLiaoDAO extends BaseDAO {
	public ShouLiaoItem getAcntItemFromShouLiao(Sheet sheet, int startRowIndex) {
		ShouLiaoItem item = new ShouLiaoItem();
		...
		try {
			...
			value = ExcelParseUtil.getSpecCellValue(sheet, "L" + (startRowIndex+2));  // L2
			...
			for (int i = 0; i < StaticVariables.SubItemsCnt_ShouLiaoDan; i++) {
				int rowIndex = startRowIndex
						+ StaticVariables.SubItemStartRow_ShouLiaoDan + i;
